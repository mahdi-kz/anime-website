...
import backgroundImage1 from '../../images/background/digital-media-bg-1.webp';
import backgroundImage2 from '../../images/background/digital-media-bg-2.webp';
import backgroundImage3 from '../../images/background/digital-media-bg-3.webp';
import backgroundImage4 from '../../images/background/digital-media-bg-4.webp';
import backgroundImage5 from '../../images/background/digital-media-bg-5.webp';
...
export default function Products(props){
	...
	return(
		...
		>
		    <div className='digital-background-elements'>
		        <img src={backgroundImage1} data-aos={'fade-left'} className='digital-bg-1'/>
                <img src={backgroundImage2} data-aos={'fade-right'} className='digital-bg-2'/>
                <img src={backgroundImage3} data-aos={'fade-right'} className='digital-bg-3'/>
                <img src={backgroundImage4} data-aos={'fade-down'} className='digital-bg-4'/>
                <img src={backgroundImage5} data-aos={'fade-up'} className='digital-bg-5'/>
		    </div>
